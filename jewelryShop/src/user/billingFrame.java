...
public class billingFrame extends javax.swing.JFrame {
 private final ArrayList<String> billingInfo = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(354, 360, 90, 30));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 530, 430));

        setSize(new java.awt.Dimension(545, 457));
    ...
    private void checkoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutActionPerformed
        ...
        // Create ArrayList to store billing information
        billingInfo.add("Name: " + name);
        billingInfo.add("Address: " + address1);
        billingInfo.add("Total Amount: " + totalAmountText);
        billingInfo.add("Amount to Pay: " + amountToPayText);
        ...
        if (name.isEmpty() || emailAddress.isEmpty() || address1.isEmpty() ||
            ...
            try {
                ...
                if (totalAmount < amountToPay) {
                    ...
                    receiptFrame.setInformation(name, address1, totalAmountText, amountToPayText, billingInfo);
