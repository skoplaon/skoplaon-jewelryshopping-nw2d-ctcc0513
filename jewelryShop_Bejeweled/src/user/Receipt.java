...
public class Receipt extends javax.swing.JFrame {
   ...
   public void setInformation(String fullName, String address, String totalAmount, String amountToPay,  ArrayList<String> billingInfo) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(exchangeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 430, 150, 32));
        ...
        getContentPane().add(amountToPayLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 390, 190, 40));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 470, -1, -1));

        Cash.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Cash.setText("Cash");
        getContentPane().add(Cash, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 390, 40, 30));
        ...
        getContentPane().add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 160, 30));
